...
public abstract class VeAbsSpinner extends VeAdapterView<SpinnerAdapter> {
  ...
  public VeAbsSpinner(Context context, AttributeSet attrs) {
    this(context, attrs, 0);
  }

  public VeAbsSpinner(Context context, AttributeSet attrs, int defStyle) {
    super(context, attrs, defStyle);
    initAbsSpinner();

    //        TypedArray a = context.obtainStyledAttributes(attrs,
    //               R.styleable.VeAbsSpinner, defStyle, 0);

    //       CharSequence[] entries = a.getTextArray(R.styleable.VeAbsSpinner_android_entries);
    //        if (entries != null) {
    //            ArrayAdapter<CharSequence> adapter =
    //                    new ArrayAdapter<CharSequence>(context,
    //                            R.layout.ve_simple_spinner_item, entries);
    //            adapter.setDropDownViewResource(R.layout.ve_simple_spinner_dropdown_item);
    //            setAdapter(adapter);
    //        }
  ...
  @Override protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
    ...
    mSpinnerPadding.left =
        getPaddingLeft() > mSelectionLeftPadding ? getPaddingLeft() : mSelectionLeftPadding;
    mSpinnerPadding.top =
        getPaddingTop() > mSelectionTopPadding ? getPaddingTop() : mSelectionTopPadding;
    mSpinnerPadding.right =
        getPaddingRight() > mSelectionRightPadding ? getPaddingRight() : mSelectionRightPadding;
    ...
    if (widthMode != View.MeasureSpec.EXACTLY && selectedPosition >= 0 && mAdapter != null) {
  ...
  @Override void handleDataChanged() {
  ...
  static class SavedState extends View.BaseSavedState {
    ...
    @Override public String toString() {
      return "VeAbsSpinner.SavedState{"
