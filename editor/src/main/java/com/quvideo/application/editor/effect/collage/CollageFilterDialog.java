...
import com.quvideo.mobile.engine.work.operate.effect.EffectOPFilterInfo;
import java.util.ArrayList;
import java.util.Arrays;
import java.util.List;
import org.json.JSONObject;

public class CollageFilterDialog extends BaseMenuView {
  ...
  public CollageFilterDialog(Context context, MenuContainer container, IQEWorkSpace workSpace,
    ...
    mCustomSeekbarPop.init(new CustomSeekbarPop.InitBuilder()
        ...
        .seekOverListener(new DoubleSeekbar.OnSeekbarListener() {
          ...
          @Override public void onSeekChange(boolean isFirst, int progress) {
            ...
            FilterInfo filterInfo = ((AnimEffect) mWorkSpace.getEffectAPI().getEffect(groupId, effectIndex)).mFilterInfo;
            if (filterInfo != null) {
