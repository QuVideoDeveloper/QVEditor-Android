...
public class RCHelper {
  ...
  public void initAttrs(Context context, AttributeSet attrs) {
    ...
    int roundCornerBottomRight =
        ta.getDimensionPixelSize(R.styleable.RCAttrs_round_corner_bottom_right, roundCorner);
    ta.recycle();
  ...
  public void refreshRegion(View view) {
    ...
    Region clip =
        new Region((int) areas.left, (int) areas.top, (int) areas.right, (int) areas.bottom);
